...
import FooterNewLater from "../components/FooterNewLater";
...
export default function Home() {
  ...
  return (
    <div
      id="page"
      className="site page-single showmodal site page-category showdpt"
    >
      <SiteOff></SiteOff>
      <header>
        <TopNav></TopNav>
