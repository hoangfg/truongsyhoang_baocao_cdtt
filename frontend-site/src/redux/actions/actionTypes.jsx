...
export const BOOKS_LOADING_SET = "BOOKS_LOADING_SET";

// Authors
export const AUTHORS_LOADING_SET = "AUTHORS_LOADING_SET";

// Genres
export const GENRES_LOADING_SET = "GENRES_LOADING_SET";

// Publishers
export const PUBLISHERS_LOADING_SET = "PUBLISHERS_LOADING_SET";

// Languages
export const LANGUAGES_LOADING_SET = "LANGUAGES_LOADING_SET";
// POSTS_LOADING_SET
export const POSTS_LOADING_SET = "POSTS_LOADING_SET";
// TOPICS_LOADING_SET
export const TOPICS_LOADING_SET = "TOPICS_LOADING_SET";
